...
def test_run_forwards_trigger_and_dispatch_request_id_to_run_scheduled_batch(monkeypatch):
    ...
    def _fake_run_scheduled_batch(batch_kind, moment, calendar_repository, daily_bar_provider, gateway, ls_client, *, query_index=None, trigger=None, dispatch_request_id=None):
