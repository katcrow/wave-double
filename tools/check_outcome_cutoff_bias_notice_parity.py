...
def compute_reference_rows(rows: list[dict]) -> list[dict]:
    ...
    for strategy in [*strategies, None]:
        ...
        result.append({
            ...
            "win_rate_threshold_pp": WIN_RATE_THRESHOLD_PP if expected_profit_factor is not None else None,
            "profit_factor_threshold_ratio": PROFIT_FACTOR_THRESHOLD_RATIO if expected_profit_factor is not None else None,
