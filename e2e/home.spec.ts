...
// Story 4.6/4.7/4.8/4.10: 인증 세션을 발급하는 CI fixture가 아직 없어 근거 패널의 클릭/키보드/태그
// 링크·반응형 표현, 시장 패널의 탭/URL 보존, 힌트 배지·필터 조작을 브라우저 테스트로 실행하지 않는다. 아래 미인증
// redirect 회귀와 순수 함수/운영 SQL fixture가 현재 자동 검증 범위이며, 인증 세션이 준비되면
// 이 파일에 후보·시장 패널 smoke를 추가한다.
