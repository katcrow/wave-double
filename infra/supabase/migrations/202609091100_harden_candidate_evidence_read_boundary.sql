-- Epic 4 acceptance remediation: published read boundary, candidate-day guard,
-- and adjusted-price projection for candidate evidence.
-- Existing migrations are immutable; this correction is forward-only.
begin;
